...
#include "tracer_sdk/async_io/async_can.hpp"
#include "tracer_sdk/async_io/async_serial.hpp"
...
#include "tracer_sdk/tracer_types.hpp"
...
private:
    ...
    void NewStatusMsgReceivedCallback(const TracerStatusMessage &msg);

public:
    static void UpdateTracerState(const TracerStatusMessage &status_msg, TracerState &state);
};
} // namespace wescore
