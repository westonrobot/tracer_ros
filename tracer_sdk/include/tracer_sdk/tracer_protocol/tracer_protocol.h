...
typedef enum
{
    TracerControlNone = 0x20,
    TracerMotionControlMsg = 0x21,
    TracerLightControlMsg = 0x22
} TracerControlMsgType;

typedef struct 
{
    TracerControlMsgType msg_type;

    // only one of the following fields is updated, as specified by msg_type
    MotionControlMessage motion_control_msg;
    LightControlMessage light_control_msg;
} TracerControlMessage;
